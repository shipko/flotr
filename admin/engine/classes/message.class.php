...
class message {
    public $array_mess=array(
        ...
        14 => array('class' => 'update', 'text' => 'Категория добавлена'),
        15 => array('class' => 'update', 'text' => 'Категория обновлена'),
        16 => array('class' => 'update', 'text' => 'Категория удалена'),
        17 => array('class' => 'update', 'text' => 'Предмет обновлен'),
        );
